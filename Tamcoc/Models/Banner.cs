...
namespace Tamcoc.Models
{
    public class Banner
    {
        ...
        [Display(Name = "Video Banner"), StringLength(500)]
        ...
        public virtual ICollection<BannerEn> BannerEns { get; set; }
        public virtual ICollection<BannerFr> BannerFrs { get; set; }
    }
