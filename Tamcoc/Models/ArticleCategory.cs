...
namespace Tamcoc.Models
{
    public class ArticleCategory
    {
        ...
        public virtual ICollection<ArticleCategoryEn> ArticleCategoryEns { get; set; }
        public virtual ICollection<ArticleCategoryFn>  ArticleCategoryFns { get; set; }
    ...
    public class ArticleCategoryEn
    {
        [Key, Column(Order = 1)]
    ...
    public class ArticleCategoryFn
    {
        [Key, Column(Order = 1)]
        public int ArticleCategoryId { get; set; }
        [Key, Column(Order = 2)]
    ...
    public enum TypePost
    {
        ...
        Service,
        [Display(Name = "Danh mục điều khoản")]
        Policy
    }
}