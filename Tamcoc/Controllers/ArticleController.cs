...
namespace Tamcoc.Controllers
{
    ...
    public class ArticleController : Controller
    {
        ...
        public ActionResult UpdateArticleCategoryEn(int catId, int result = 0)
        {
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult UpdateArticleCategoryEn(FormCollection fc)
        {
            ...
            var conceptCategoryLang = _unitOfWork.ArticleCategoryEnRepository.GetQuery(a => a.ArticleCategoryId == catId && a.LanguageId == langId).SingleOrDefault();

            if (conceptCategoryLang == null)
            {
                _unitOfWork.ArticleCategoryEnRepository.Insert(new ArticleCategoryEn
                {
        ...
        public ActionResult UpdateArticleCategoryFr(int catId, int result = 0)
        {
            ViewBag.Result = result;
            var category = _unitOfWork.ArticleCategoryRepository.GetById(catId);
            return View(category);
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult UpdateArticleCategoryFr(FormCollection fc)
        {
            var catId = Convert.ToInt32(fc["ArticleCategoryId"]);
            var langId = Convert.ToInt32(fc["LangId"]);
            var name = fc["Name"];
            ...
            var conceptCategoryLang = _unitOfWork.ArticleCategoryFrRepository.GetQuery(a => a.ArticleCategoryId == catId && a.LanguageId == langId).SingleOrDefault();

            if (conceptCategoryLang == null)
            {
                _unitOfWork.ArticleCategoryFrRepository.Insert(new ArticleCategoryFn
                {
                    ArticleCategoryId = catId,
                    LanguageId = langId,
                    CategoryName = name,
                ...
                _unitOfWork.Save();
                return RedirectToAction("UpdateArticleCategoryFr", new { catId, result = 1 });
            }
            conceptCategoryLang.CategoryName = name;
            conceptCategoryLang.Description = description;
            conceptCategoryLang.Url = HtmlHelpers.ConvertToUnSign(null, url == "" ? name : url);
        ...
        public ActionResult Article(InsertArticleViewModel model, FormCollection fc)
        {
            if (ModelState.IsValid)
            {
                ...
                if (isPost)
                {
                    model.Article.ListImage = fc["Pictures"];
        ...
        public ActionResult UpdateArticle(InsertArticleViewModel model, FormCollection fc)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (isPost)
                {
                    article.ListImage = fc["Pictures"] == "" ? null : fc["Pictures"];
        ...
        public ActionResult UpdateArticleEn(int artId, int result = 0)
        {
            ViewBag.Result = result;
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult UpdateArticleEn(FormCollection fc)
        {
            ...
            var conceptLang = _unitOfWork.ArticleEnRepository.GetQuery(a => a.ArticleId == artId && a.LanguageId == langId).SingleOrDefault();

            if (conceptLang == null)
            {
                _unitOfWork.ArticleEnRepository.Insert(new ArticleEn
                {
                    ArticleId = artId,
                    LanguageId = langId,
                    Subject = name,
        ...
        public ActionResult UpdateArticleFr(int artId, int result = 0)
        {
            ViewBag.Result = result;
            var article = _unitOfWork.ArticleRepository.GetById(artId);
            return View(article);
        ...
        [HttpPost, ValidateInput(false)]
        public ActionResult UpdateArticleFr(FormCollection fc)
        {
            var artId = Convert.ToInt32(fc["ArticleId"]);
            var langId = Convert.ToInt32(fc["LangId"]);
            var name = fc["Name"];
            ...
            var conceptLang = _unitOfWork.ArticleFrRepository.GetQuery(a => a.ArticleId == artId && a.LanguageId == langId).SingleOrDefault();

            if (conceptLang == null)
            {
                _unitOfWork.ArticleFrRepository.Insert(new ArticleFr
                {
                    ArticleId = artId,
                    LanguageId = langId,
                    Subject = name,
